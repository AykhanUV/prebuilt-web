...
const apks = [
  ...
  { name: 'AfnMusic', logo: 'afnmusic.png', desc: 'This app is modified YouTube Music app with no ads and custom features', downloadLink: 'https://github.com/AykhanUV/AfnMusic/releases/download/AfnMusic(7.25.52)/AfnMusic.apk' },
  ...
  { name: 'Minecraft', logo: 'minecraft.png', desc: 'Minecraft arm64-v8a apk. Music is cut off to reduce file size', downloadLink: 'https://github.com/AykhanUV/mc/releases/download/1.21.30.03/Minecraft-v1.21.51.02-arm64-v8a-compressed.apk' }
]
